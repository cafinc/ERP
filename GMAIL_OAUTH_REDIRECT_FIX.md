...
```
GOOGLE_REDIRECT_URI=https://snowops-admin.preview.emergentagent.com/api/gmail/oauth/callback
```
...
4. Under "Authorized redirect URIs", add:
   ```
   https://snowops-admin.preview.emergentagent.com/api/gmail/oauth/callback
   ```
5. Click "Save"
