...
```
GOOGLE_REDIRECT_URI=https://webadmin-jsx.preview.emergentagent.com/api/gmail/oauth/callback
```
...
4. Under "Authorized redirect URIs", add:
   ```
   https://webadmin-jsx.preview.emergentagent.com/api/gmail/oauth/callback
   ```
5. Click "Save"
