...
```
GOOGLE_REDIRECT_URI=https://webadmin-rescue.preview.emergentagent.com/api/gmail/oauth/callback
```
...
4. Under "Authorized redirect URIs", add:
   ```
   https://webadmin-rescue.preview.emergentagent.com/api/gmail/oauth/callback
   ```
5. Click "Save"
