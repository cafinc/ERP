...
```
GOOGLE_REDIRECT_URI=https://task-hub-modern.preview.emergentagent.com/api/gmail/oauth/callback
```
...
4. Under "Authorized redirect URIs", add:
   ```
   https://task-hub-modern.preview.emergentagent.com/api/gmail/oauth/callback
   ```
5. Click "Save"
