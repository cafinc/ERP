...
```
GOOGLE_REDIRECT_URI=https://erp-modernizer.preview.emergentagent.com/api/gmail/oauth/callback
```
...
4. Under "Authorized redirect URIs", add:
   ```
   https://erp-modernizer.preview.emergentagent.com/api/gmail/oauth/callback
   ```
5. Click "Save"
