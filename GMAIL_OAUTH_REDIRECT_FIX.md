...
```
GOOGLE_REDIRECT_URI=https://service-hub-156.preview.emergentagent.com/api/gmail/oauth/callback
```
...
4. Under "Authorized redirect URIs", add:
   ```
   https://service-hub-156.preview.emergentagent.com/api/gmail/oauth/callback
   ```
5. Click "Save"
