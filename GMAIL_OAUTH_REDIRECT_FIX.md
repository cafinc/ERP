...
```
GOOGLE_REDIRECT_URI=https://modern-admin-dash-1.preview.emergentagent.com/api/gmail/oauth/callback
```
...
4. Under "Authorized redirect URIs", add:
   ```
   https://modern-admin-dash-1.preview.emergentagent.com/api/gmail/oauth/callback
   ```
5. Click "Save"
