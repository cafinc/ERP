...
```
GOOGLE_REDIRECT_URI=https://erp-modernize-2.preview.emergentagent.com/api/gmail/oauth/callback
```
...
4. Under "Authorized redirect URIs", add:
   ```
   https://erp-modernize-2.preview.emergentagent.com/api/gmail/oauth/callback
   ```
5. Click "Save"
