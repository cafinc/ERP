...
```
GOOGLE_REDIRECT_URI=https://mapbuilder-3.preview.emergentagent.com/api/gmail/oauth/callback
```
...
4. Under "Authorized redirect URIs", add:
   ```
   https://mapbuilder-3.preview.emergentagent.com/api/gmail/oauth/callback
   ```
5. Click "Save"
