...
```
GOOGLE_REDIRECT_URI=https://plowpro-admin-1.preview.emergentagent.com/api/gmail/oauth/callback
```
...
4. Under "Authorized redirect URIs", add:
   ```
   https://plowpro-admin-1.preview.emergentagent.com/api/gmail/oauth/callback
   ```
5. Click "Save"
