...
```
GOOGLE_REDIRECT_URI=https://mapforge-20.preview.emergentagent.com/api/gmail/oauth/callback
```
...
4. Under "Authorized redirect URIs", add:
   ```
   https://mapforge-20.preview.emergentagent.com/api/gmail/oauth/callback
   ```
5. Click "Save"
