...
```
GOOGLE_REDIRECT_URI=https://asset-mgmt-portal.preview.emergentagent.com/api/gmail/oauth/callback
```
...
4. Under "Authorized redirect URIs", add:
   ```
   https://asset-mgmt-portal.preview.emergentagent.com/api/gmail/oauth/callback
   ```
5. Click "Save"
