...
```
GOOGLE_REDIRECT_URI=https://service-history-app.preview.emergentagent.com/api/gmail/oauth/callback
```
...
4. Under "Authorized redirect URIs", add:
   ```
   https://service-history-app.preview.emergentagent.com/api/gmail/oauth/callback
   ```
5. Click "Save"
