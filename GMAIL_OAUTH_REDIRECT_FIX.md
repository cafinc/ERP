...
```
GOOGLE_REDIRECT_URI=https://snowadmin-dash.preview.emergentagent.com/api/gmail/oauth/callback
```
...
4. Under "Authorized redirect URIs", add:
   ```
   https://snowadmin-dash.preview.emergentagent.com/api/gmail/oauth/callback
   ```
5. Click "Save"
