...
```
GOOGLE_REDIRECT_URI=https://header-refresh-4.preview.emergentagent.com/api/gmail/oauth/callback
```
...
4. Under "Authorized redirect URIs", add:
   ```
   https://header-refresh-4.preview.emergentagent.com/api/gmail/oauth/callback
   ```
5. Click "Save"
