...
```
GOOGLE_REDIRECT_URI=https://admin-dash-restore.preview.emergentagent.com/api/gmail/oauth/callback
```
...
4. Under "Authorized redirect URIs", add:
   ```
   https://admin-dash-restore.preview.emergentagent.com/api/gmail/oauth/callback
   ```
5. Click "Save"
