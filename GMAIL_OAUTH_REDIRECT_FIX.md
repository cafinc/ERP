...
```
GOOGLE_REDIRECT_URI=https://custflow-1.preview.emergentagent.com/api/gmail/oauth/callback
```
...
4. Under "Authorized redirect URIs", add:
   ```
   https://custflow-1.preview.emergentagent.com/api/gmail/oauth/callback
   ```
5. Click "Save"
