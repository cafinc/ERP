...
```
GOOGLE_REDIRECT_URI=https://client-hub-48.preview.emergentagent.com/api/gmail/oauth/callback
```
...
4. Under "Authorized redirect URIs", add:
   ```
   https://client-hub-48.preview.emergentagent.com/api/gmail/oauth/callback
   ```
5. Click "Save"
