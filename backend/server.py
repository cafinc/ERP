...
async def update_user(user_id: str, user_update: UserUpdate):
    ...
    if is_now_driver and not was_driver and not user.get("driver_license_photo"):
        ...
        upload_link = f"https://snowtrack-admin-1.preview.emergentagent.com/upload-license/{user_id_str}"
                ...
                try:
                    ...
                    response = await loop.run_in_executor(
                        ...
                        lambda: requests.post(
                            f"https://snowtrack-admin-1.preview.emergentagent.com/api/quickbooks/customers?user_id={user_id}",
...
async def gmail_oauth_callback(code: str, state: str):
    ...
    try:
        ...
        redirect_base = "https://snowtrack-admin-1.preview.emergentagent.com"
