      ...
      <div className="space-y-6">
        ...
        <div className="flex justify-between items-center">
          ...
          <button
            ...
            className="flex items-center gap-2 bg-[#3f72af] text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition-colors"
          >
          ...
          <div className="bg-white rounded-lg p-6 max-w-md w-full">
            ...
            <div className="border-2 border-dashed border-gray-300 rounded-lg p-12 text-center">
              ...
              <button 
                ...
                disabled={uploading}
                className="mt-4 px-4 py-2 bg-[#3f72af] text-white rounded-lg hover:bg-blue-700 disabled:opacity-50 disabled:cursor-not-allowed"
              >
