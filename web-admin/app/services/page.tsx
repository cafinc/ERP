          ...
          <div className="fixed inset-0 bg-gray-900/20 backdrop-blur-sm flex items-center justify-center z-50 p-4 animate-fadeIn overflow-y-auto">
            <div className="bg-white/95 backdrop-blur-md rounded-3xl max-w-2xl w-full shadow-2xl border border-white/40 animate-slideUp my-8">
              ...
              <form onSubmit={handleCreate} className="p-6 space-y-6 max-h-[calc(90vh-180px)] overflow-y-auto">
                ...
                <div className="bg-white/60 rounded-2xl shadow-lg border border-white/40 backdrop-blur-sm overflow-hidden">
                  {/* Header */}
                  <div className="bg-gradient-to-br from-purple-50 to-indigo-50 border-b-2 border-purple-100 p-6">
                    <h3 className="text-lg font-bold text-gray-900 flex items-center">
                      <Truck className="w-5 h-5 text-purple-600 mr-2" />
                      Equipment & Rates
                    </h3>
                    <p className="text-sm text-gray-600 mt-1">Select equipment and set rates for each</p>
                  </div>
                ...
                <div className="bg-white/60 rounded-2xl shadow-lg border border-white/40 backdrop-blur-sm overflow-hidden">
                  {/* Header */}
                  <div className="bg-gradient-to-br from-teal-50 to-cyan-50 border-b-2 border-teal-100 p-6">
                    <h3 className="text-lg font-bold text-gray-900 flex items-center">
                      <Link className="w-5 h-5 text-teal-600 mr-2" />
                      Trailers & Rates
                    </h3>
                    <p className="text-sm text-gray-600 mt-1">Select trailers and set rates for each</p>
                  </div>
                ...
                <div className="bg-white/60 rounded-2xl shadow-lg border border-white/40 backdrop-blur-sm overflow-hidden">
                  {/* Header */}
                  <div className="bg-gradient-to-br from-amber-50 to-yellow-50 border-b-2 border-amber-100 p-6">
                    <h3 className="text-lg font-bold text-gray-900 flex items-center">
                      <Wrench className="w-5 h-5 text-amber-600 mr-2" />
                      Tools & Rates
                    </h3>
                    <p className="text-sm text-gray-600 mt-1">Select tools and set rates for each</p>
                  </div>
                ...
                <div className="bg-white/60 rounded-2xl shadow-lg border border-white/40 backdrop-blur-sm overflow-hidden">
                  ...
                  <div className="bg-gradient-to-br from-rose-50 to-pink-50 border-b-2 border-rose-100 p-6 flex items-center justify-between">
                    ...
                    <label className="flex items-center cursor-pointer group">
                      <span className="mr-3 text-sm font-semibold text-gray-700">Required</span>
                      <div className="relative">
                        <input
                          type="checkbox"
