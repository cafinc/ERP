...
export default function HybridNavigationTopBar({ children }: { children: React.ReactNode }) {
  ...
  const menuItems: MenuItem[] = [
    ...
    },
    {
      ...
      icon: UserCog,
      submenu: [
        { label: 'Access Control', href: '/access', icon: UserCog },
    ...
    },
    {
      ...
      submenu: [
        ...
        { label: 'Route Optimization', href: '/routes/optimize', icon: MapPin },
        ...
        { label: 'Consumables Analytics', href: '/consumables/analytics', icon: LayoutDashboard },
    ...
    },
    {
      ...
      submenu: [
        ...
        { label: 'RC Active Calls', href: '/ringcentral/active-calls', icon: Users },
        { label: 'RC SMS', href: '/ringcentral/sms', icon: Users },
    ...
    },
    {
      ...
      icon: Link2,
      submenu: [
        { label: 'Integration Hub', href: '/integrations', icon: Link2 },
        { label: 'QuickBooks', href: '/settings/quickbooks', icon: DollarSign },
        { label: 'Microsoft 365', href: '/integrations?type=microsoft_365', icon: Link2 },
      ],
    },
    {
      label: 'Settings',
      ...
      submenu: [
        ...
        { label: 'App Integration', href: '/settings/app-integration', icon: Link2 },
