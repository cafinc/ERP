  ...
  const menuItems: MenuItem[] = [
    ...
    },
    {
      ...
      submenu: [
        ...
        { label: 'Equipment', href: '/asset', icon: Settings },
        { label: 'Vehicles', href: '/asset', icon: MapPin },
        { label: 'Trailers', href: '/asset', icon: Settings },
        { label: 'Tools', href: '/asset', icon: Settings },
        { label: 'Inventory', href: '/inventory', icon: FolderOpen },
