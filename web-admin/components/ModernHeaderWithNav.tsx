          ...
          <div className="flex items-center gap-3">
            ...
            <div ref={quickAddRef} className="relative flex-shrink-0">
              <button
                ...
                className="p-3 rounded-lg transition-all duration-200 cursor-pointer hover:scale-110"
                style={{
                ...
                title="Quick Add"
              >
                <Plus className={`w-8 h-8 transition-transform duration-200 ${showQuickAdd ? 'text-gray-600' : 'text-white'}`} />
              </button>
