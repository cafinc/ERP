...
**URL to provide:**
```
https://asset-dashboard-36.preview.emergentagent.com/settings/quickbooks
```
...
```
Privacy Policy URL:
https://asset-dashboard-36.preview.emergentagent.com/legal/privacy

End-User License Agreement URL (Terms of Service):
https://asset-dashboard-36.preview.emergentagent.com/legal/terms
```

### OAuth Configuration
```
Redirect URI:
https://asset-dashboard-36.preview.emergentagent.com/api/quickbooks/auth/callback
```
...
| **Launch URL** | `https://asset-dashboard-36.preview.emergentagent.com/settings/quickbooks` |
| **Disconnect URL** | `https://asset-dashboard-36.preview.emergentagent.com/settings/quickbooks` |
| **Privacy Policy URL** | `https://asset-dashboard-36.preview.emergentagent.com/legal/privacy` |
| **Terms of Service URL** | `https://asset-dashboard-36.preview.emergentagent.com/legal/terms` |
| **Redirect URI** | `https://asset-dashboard-36.preview.emergentagent.com/api/quickbooks/auth/callback` |
...
```
Launch URL: https://asset-dashboard-36.preview.emergentagent.com
Disconnect URL: https://asset-dashboard-36.preview.emergentagent.com
```
**Pros:**
...
```
Launch URL: https://asset-dashboard-36.preview.emergentagent.com/settings
Disconnect URL: https://asset-dashboard-36.preview.emergentagent.com/settings
```
**Pros:**
...
- [ ] Launch URL configured: `https://asset-dashboard-36.preview.emergentagent.com/settings/quickbooks`
- [ ] Disconnect URL configured: `https://asset-dashboard-36.preview.emergentagent.com/settings/quickbooks`
- [ ] Privacy Policy URL configured: `https://asset-dashboard-36.preview.emergentagent.com/legal/privacy`
- [ ] Terms of Service URL configured: `https://asset-dashboard-36.preview.emergentagent.com/legal/terms`
- [ ] Redirect URI configured: `https://asset-dashboard-36.preview.emergentagent.com/api/quickbooks/auth/callback`
