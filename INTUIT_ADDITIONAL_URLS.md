...
**URL to provide:**
```
https://task-hub-modern.preview.emergentagent.com/settings/quickbooks
```
...
```
https://task-hub-modern.preview.emergentagent.com
```
...
```
Privacy Policy URL:
https://task-hub-modern.preview.emergentagent.com/legal/privacy

End-User License Agreement URL (Terms of Service):
https://task-hub-modern.preview.emergentagent.com/legal/terms
```
...
| **Launch URL** | `https://task-hub-modern.preview.emergentagent.com/settings/quickbooks` |
| **Disconnect URL** | `https://task-hub-modern.preview.emergentagent.com/settings/quickbooks` |
| **Privacy Policy URL** | `https://task-hub-modern.preview.emergentagent.com/legal/privacy` |
| **Terms of Service URL** | `https://task-hub-modern.preview.emergentagent.com/legal/terms` |
...
```
Launch URL: https://task-hub-modern.preview.emergentagent.com
Disconnect URL: https://task-hub-modern.preview.emergentagent.com
```
**Pros:**
...
```
Launch URL: https://task-hub-modern.preview.emergentagent.com/settings
Disconnect URL: https://task-hub-modern.preview.emergentagent.com/settings
```
**Pros:**
...
- [ ] Launch URL configured: `https://task-hub-modern.preview.emergentagent.com/settings/quickbooks`
- [ ] Disconnect URL configured: `https://task-hub-modern.preview.emergentagent.com/settings/quickbooks`
- [ ] Privacy Policy URL configured: `https://task-hub-modern.preview.emergentagent.com/legal/privacy`
- [ ] Terms of Service URL configured: `https://task-hub-modern.preview.emergentagent.com/legal/terms`
- [ ] Redirect URI configured: `https://task-hub-modern.preview.emergentagent.com/api/quickbooks/auth/callback`
