...
**URL to provide:**
```
https://snowmap-admin.preview.emergentagent.com/settings/quickbooks
```
...
```
https://snowmap-admin.preview.emergentagent.com
```
...
```
Privacy Policy URL:
https://snowmap-admin.preview.emergentagent.com/legal/privacy

End-User License Agreement URL (Terms of Service):
https://snowmap-admin.preview.emergentagent.com/legal/terms
```
...
| **Launch URL** | `https://snowmap-admin.preview.emergentagent.com/settings/quickbooks` |
| **Disconnect URL** | `https://snowmap-admin.preview.emergentagent.com/settings/quickbooks` |
| **Privacy Policy URL** | `https://snowmap-admin.preview.emergentagent.com/legal/privacy` |
| **Terms of Service URL** | `https://snowmap-admin.preview.emergentagent.com/legal/terms` |
| **Redirect URI** | `https://snowmap-admin.preview.emergentagent.com/api/quickbooks/auth/callback` |
...
```
Launch URL: https://snowmap-admin.preview.emergentagent.com
Disconnect URL: https://snowmap-admin.preview.emergentagent.com
```
**Pros:**
...
```
Launch URL: https://snowmap-admin.preview.emergentagent.com/settings
Disconnect URL: https://snowmap-admin.preview.emergentagent.com/settings
```
**Pros:**
...
- [ ] Launch URL configured: `https://snowmap-admin.preview.emergentagent.com/settings/quickbooks`
- [ ] Disconnect URL configured: `https://snowmap-admin.preview.emergentagent.com/settings/quickbooks`
- [ ] Privacy Policy URL configured: `https://snowmap-admin.preview.emergentagent.com/legal/privacy`
- [ ] Terms of Service URL configured: `https://snowmap-admin.preview.emergentagent.com/legal/terms`
- [ ] Redirect URI configured: `https://snowmap-admin.preview.emergentagent.com/api/quickbooks/auth/callback`
