...
**URL to provide:**
```
https://fieldview-3.preview.emergentagent.com/settings/quickbooks
```
...
```
https://fieldview-3.preview.emergentagent.com
```
...
```
Privacy Policy URL:
https://fieldview-3.preview.emergentagent.com/legal/privacy

End-User License Agreement URL (Terms of Service):
https://fieldview-3.preview.emergentagent.com/legal/terms
```

### OAuth Configuration
```
Redirect URI:
https://fieldview-3.preview.emergentagent.com/api/quickbooks/auth/callback
```
...
| **Launch URL** | `https://fieldview-3.preview.emergentagent.com/settings/quickbooks` |
| **Disconnect URL** | `https://fieldview-3.preview.emergentagent.com/settings/quickbooks` |
| **Privacy Policy URL** | `https://fieldview-3.preview.emergentagent.com/legal/privacy` |
| **Terms of Service URL** | `https://fieldview-3.preview.emergentagent.com/legal/terms` |
| **Redirect URI** | `https://fieldview-3.preview.emergentagent.com/api/quickbooks/auth/callback` |
...
```
Launch URL: https://fieldview-3.preview.emergentagent.com
Disconnect URL: https://fieldview-3.preview.emergentagent.com
```
**Pros:**
...
```
Launch URL: https://fieldview-3.preview.emergentagent.com/settings
Disconnect URL: https://fieldview-3.preview.emergentagent.com/settings
```
**Pros:**
...
- [ ] Launch URL configured: `https://fieldview-3.preview.emergentagent.com/settings/quickbooks`
- [ ] Disconnect URL configured: `https://fieldview-3.preview.emergentagent.com/settings/quickbooks`
- [ ] Privacy Policy URL configured: `https://fieldview-3.preview.emergentagent.com/legal/privacy`
- [ ] Terms of Service URL configured: `https://fieldview-3.preview.emergentagent.com/legal/terms`
- [ ] Redirect URI configured: `https://fieldview-3.preview.emergentagent.com/api/quickbooks/auth/callback`
