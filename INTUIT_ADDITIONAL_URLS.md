...
**URL to provide:**
```
https://snowops-admin.preview.emergentagent.com/settings/quickbooks
```
...
```
https://snowops-admin.preview.emergentagent.com
```
...
```
Privacy Policy URL:
https://snowops-admin.preview.emergentagent.com/legal/privacy

End-User License Agreement URL (Terms of Service):
https://snowops-admin.preview.emergentagent.com/legal/terms
```
...
| **Launch URL** | `https://snowops-admin.preview.emergentagent.com/settings/quickbooks` |
| **Disconnect URL** | `https://snowops-admin.preview.emergentagent.com/settings/quickbooks` |
| **Privacy Policy URL** | `https://snowops-admin.preview.emergentagent.com/legal/privacy` |
| **Terms of Service URL** | `https://snowops-admin.preview.emergentagent.com/legal/terms` |
| **Redirect URI** | `https://snowops-admin.preview.emergentagent.com/api/quickbooks/auth/callback` |
...
```
Launch URL: https://snowops-admin.preview.emergentagent.com
Disconnect URL: https://snowops-admin.preview.emergentagent.com
```
**Pros:**
...
```
Launch URL: https://snowops-admin.preview.emergentagent.com/settings
Disconnect URL: https://snowops-admin.preview.emergentagent.com/settings
```
**Pros:**
...
- [ ] Launch URL configured: `https://snowops-admin.preview.emergentagent.com/settings/quickbooks`
- [ ] Disconnect URL configured: `https://snowops-admin.preview.emergentagent.com/settings/quickbooks`
- [ ] Privacy Policy URL configured: `https://snowops-admin.preview.emergentagent.com/legal/privacy`
- [ ] Terms of Service URL configured: `https://snowops-admin.preview.emergentagent.com/legal/terms`
- [ ] Redirect URI configured: `https://snowops-admin.preview.emergentagent.com/api/quickbooks/auth/callback`
