...
**URL to provide:**
```
https://modern-admin-dash-1.preview.emergentagent.com/settings/quickbooks
```
...
```
https://modern-admin-dash-1.preview.emergentagent.com
```
...
```
Privacy Policy URL:
https://modern-admin-dash-1.preview.emergentagent.com/legal/privacy

End-User License Agreement URL (Terms of Service):
https://modern-admin-dash-1.preview.emergentagent.com/legal/terms
```
...
| **Launch URL** | `https://modern-admin-dash-1.preview.emergentagent.com/settings/quickbooks` |
| **Disconnect URL** | `https://modern-admin-dash-1.preview.emergentagent.com/settings/quickbooks` |
| **Privacy Policy URL** | `https://modern-admin-dash-1.preview.emergentagent.com/legal/privacy` |
| **Terms of Service URL** | `https://modern-admin-dash-1.preview.emergentagent.com/legal/terms` |
...
```
Launch URL: https://modern-admin-dash-1.preview.emergentagent.com
Disconnect URL: https://modern-admin-dash-1.preview.emergentagent.com
```
**Pros:**
...
```
Launch URL: https://modern-admin-dash-1.preview.emergentagent.com/settings
Disconnect URL: https://modern-admin-dash-1.preview.emergentagent.com/settings
```
**Pros:**
...
- [ ] Launch URL configured: `https://modern-admin-dash-1.preview.emergentagent.com/settings/quickbooks`
- [ ] Disconnect URL configured: `https://modern-admin-dash-1.preview.emergentagent.com/settings/quickbooks`
- [ ] Privacy Policy URL configured: `https://modern-admin-dash-1.preview.emergentagent.com/legal/privacy`
- [ ] Terms of Service URL configured: `https://modern-admin-dash-1.preview.emergentagent.com/legal/terms`
- [ ] Redirect URI configured: `https://modern-admin-dash-1.preview.emergentagent.com/api/quickbooks/auth/callback`
