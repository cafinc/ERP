...
**URL to provide:**
```
https://snowmsg-hub.preview.emergentagent.com/settings/quickbooks
```
...
```
Privacy Policy URL:
https://snowmsg-hub.preview.emergentagent.com/legal/privacy

End-User License Agreement URL (Terms of Service):
https://snowmsg-hub.preview.emergentagent.com/legal/terms
```
...
| **Privacy Policy URL** | `https://snowmsg-hub.preview.emergentagent.com/legal/privacy` |
| **Terms of Service URL** | `https://snowmsg-hub.preview.emergentagent.com/legal/terms` |
...
```
Launch URL: https://snowmsg-hub.preview.emergentagent.com
Disconnect URL: https://snowmsg-hub.preview.emergentagent.com
```
**Pros:**
...
```
Launch URL: https://snowmsg-hub.preview.emergentagent.com/settings
Disconnect URL: https://snowmsg-hub.preview.emergentagent.com/settings
```
**Pros:**
...
- [ ] Launch URL configured: `https://snowmsg-hub.preview.emergentagent.com/settings/quickbooks`
- [ ] Disconnect URL configured: `https://snowmsg-hub.preview.emergentagent.com/settings/quickbooks`
- [ ] Privacy Policy URL configured: `https://snowmsg-hub.preview.emergentagent.com/legal/privacy`
- [ ] Terms of Service URL configured: `https://snowmsg-hub.preview.emergentagent.com/legal/terms`
- [ ] Redirect URI configured: `https://snowmsg-hub.preview.emergentagent.com/api/quickbooks/auth/callback`
