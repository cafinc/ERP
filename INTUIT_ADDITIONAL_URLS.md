...
**URL to provide:**
```
https://snowtrackr.preview.emergentagent.com/settings/quickbooks
```
...
```
https://snowtrackr.preview.emergentagent.com
```
...
```
Privacy Policy URL:
https://snowtrackr.preview.emergentagent.com/legal/privacy

End-User License Agreement URL (Terms of Service):
https://snowtrackr.preview.emergentagent.com/legal/terms
```

### OAuth Configuration
```
Redirect URI:
https://snowtrackr.preview.emergentagent.com/api/quickbooks/auth/callback
```
...
| **Launch URL** | `https://snowtrackr.preview.emergentagent.com/settings/quickbooks` |
| **Disconnect URL** | `https://snowtrackr.preview.emergentagent.com/settings/quickbooks` |
| **Privacy Policy URL** | `https://snowtrackr.preview.emergentagent.com/legal/privacy` |
| **Terms of Service URL** | `https://snowtrackr.preview.emergentagent.com/legal/terms` |
| **Redirect URI** | `https://snowtrackr.preview.emergentagent.com/api/quickbooks/auth/callback` |
...
```
Launch URL: https://snowtrackr.preview.emergentagent.com
Disconnect URL: https://snowtrackr.preview.emergentagent.com
```
**Pros:**
...
```
Launch URL: https://snowtrackr.preview.emergentagent.com/settings
Disconnect URL: https://snowtrackr.preview.emergentagent.com/settings
```
**Pros:**
...
- [ ] Launch URL configured: `https://snowtrackr.preview.emergentagent.com/settings/quickbooks`
- [ ] Disconnect URL configured: `https://snowtrackr.preview.emergentagent.com/settings/quickbooks`
- [ ] Privacy Policy URL configured: `https://snowtrackr.preview.emergentagent.com/legal/privacy`
- [ ] Terms of Service URL configured: `https://snowtrackr.preview.emergentagent.com/legal/terms`
- [ ] Redirect URI configured: `https://snowtrackr.preview.emergentagent.com/api/quickbooks/auth/callback`
