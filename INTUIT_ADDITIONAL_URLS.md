...
**URL to provide:**
```
https://erp-automation-2.preview.emergentagent.com/settings/quickbooks
```
...
```
https://erp-automation-2.preview.emergentagent.com
```
...
```
Privacy Policy URL:
https://erp-automation-2.preview.emergentagent.com/legal/privacy

End-User License Agreement URL (Terms of Service):
https://erp-automation-2.preview.emergentagent.com/legal/terms
```
...
| **Launch URL** | `https://erp-automation-2.preview.emergentagent.com/settings/quickbooks` |
| **Disconnect URL** | `https://erp-automation-2.preview.emergentagent.com/settings/quickbooks` |
| **Privacy Policy URL** | `https://erp-automation-2.preview.emergentagent.com/legal/privacy` |
| **Terms of Service URL** | `https://erp-automation-2.preview.emergentagent.com/legal/terms` |
| **Redirect URI** | `https://erp-automation-2.preview.emergentagent.com/api/quickbooks/auth/callback` |
...
```
Launch URL: https://erp-automation-2.preview.emergentagent.com
Disconnect URL: https://erp-automation-2.preview.emergentagent.com
```
**Pros:**
...
```
Launch URL: https://erp-automation-2.preview.emergentagent.com/settings
Disconnect URL: https://erp-automation-2.preview.emergentagent.com/settings
```
**Pros:**
...
- [ ] Launch URL configured: `https://erp-automation-2.preview.emergentagent.com/settings/quickbooks`
- [ ] Disconnect URL configured: `https://erp-automation-2.preview.emergentagent.com/settings/quickbooks`
- [ ] Privacy Policy URL configured: `https://erp-automation-2.preview.emergentagent.com/legal/privacy`
- [ ] Terms of Service URL configured: `https://erp-automation-2.preview.emergentagent.com/legal/terms`
- [ ] Redirect URI configured: `https://erp-automation-2.preview.emergentagent.com/api/quickbooks/auth/callback`
