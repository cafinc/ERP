...
**URL to provide:**
```
https://webadmin-jsx.preview.emergentagent.com/settings/quickbooks
```
...
| **Launch URL** | `https://webadmin-jsx.preview.emergentagent.com/settings/quickbooks` |
| **Disconnect URL** | `https://webadmin-jsx.preview.emergentagent.com/settings/quickbooks` |
| **Privacy Policy URL** | `https://webadmin-jsx.preview.emergentagent.com/legal/privacy` |
| **Terms of Service URL** | `https://webadmin-jsx.preview.emergentagent.com/legal/terms` |
| **Redirect URI** | `https://webadmin-jsx.preview.emergentagent.com/api/quickbooks/auth/callback` |
...
```
Launch URL: https://webadmin-jsx.preview.emergentagent.com
Disconnect URL: https://webadmin-jsx.preview.emergentagent.com
```
**Pros:**
...
```
Launch URL: https://webadmin-jsx.preview.emergentagent.com/settings
Disconnect URL: https://webadmin-jsx.preview.emergentagent.com/settings
```
**Pros:**
...
- [ ] Launch URL configured: `https://webadmin-jsx.preview.emergentagent.com/settings/quickbooks`
- [ ] Disconnect URL configured: `https://webadmin-jsx.preview.emergentagent.com/settings/quickbooks`
- [ ] Privacy Policy URL configured: `https://webadmin-jsx.preview.emergentagent.com/legal/privacy`
- [ ] Terms of Service URL configured: `https://webadmin-jsx.preview.emergentagent.com/legal/terms`
- [ ] Redirect URI configured: `https://webadmin-jsx.preview.emergentagent.com/api/quickbooks/auth/callback`
