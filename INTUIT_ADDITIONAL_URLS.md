...
**URL to provide:**
```
https://snowy-dashboard.preview.emergentagent.com/settings/quickbooks
```
...
```
https://snowy-dashboard.preview.emergentagent.com
```
...
```
Privacy Policy URL:
https://snowy-dashboard.preview.emergentagent.com/legal/privacy

End-User License Agreement URL (Terms of Service):
https://snowy-dashboard.preview.emergentagent.com/legal/terms
```

### OAuth Configuration
```
Redirect URI:
https://snowy-dashboard.preview.emergentagent.com/api/quickbooks/auth/callback
```
...
| **Launch URL** | `https://snowy-dashboard.preview.emergentagent.com/settings/quickbooks` |
| **Disconnect URL** | `https://snowy-dashboard.preview.emergentagent.com/settings/quickbooks` |
| **Privacy Policy URL** | `https://snowy-dashboard.preview.emergentagent.com/legal/privacy` |
| **Terms of Service URL** | `https://snowy-dashboard.preview.emergentagent.com/legal/terms` |
| **Redirect URI** | `https://snowy-dashboard.preview.emergentagent.com/api/quickbooks/auth/callback` |
...
```
Launch URL: https://snowy-dashboard.preview.emergentagent.com
Disconnect URL: https://snowy-dashboard.preview.emergentagent.com
```
**Pros:**
...
```
Launch URL: https://snowy-dashboard.preview.emergentagent.com/settings
Disconnect URL: https://snowy-dashboard.preview.emergentagent.com/settings
```
**Pros:**
...
- [ ] Launch URL configured: `https://snowy-dashboard.preview.emergentagent.com/settings/quickbooks`
- [ ] Disconnect URL configured: `https://snowy-dashboard.preview.emergentagent.com/settings/quickbooks`
- [ ] Privacy Policy URL configured: `https://snowy-dashboard.preview.emergentagent.com/legal/privacy`
- [ ] Terms of Service URL configured: `https://snowy-dashboard.preview.emergentagent.com/legal/terms`
- [ ] Redirect URI configured: `https://snowy-dashboard.preview.emergentagent.com/api/quickbooks/auth/callback`
