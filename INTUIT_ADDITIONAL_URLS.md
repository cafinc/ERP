...
**URL to provide:**
```
https://serviceflow-hub-1.preview.emergentagent.com/settings/quickbooks
```
...
| **Privacy Policy URL** | `https://serviceflow-hub-1.preview.emergentagent.com/legal/privacy` |
| **Terms of Service URL** | `https://serviceflow-hub-1.preview.emergentagent.com/legal/terms` |
...
```
Launch URL: https://serviceflow-hub-1.preview.emergentagent.com
Disconnect URL: https://serviceflow-hub-1.preview.emergentagent.com
```
**Pros:**
...
```
Launch URL: https://serviceflow-hub-1.preview.emergentagent.com/settings
Disconnect URL: https://serviceflow-hub-1.preview.emergentagent.com/settings
```
**Pros:**
...
- [ ] Launch URL configured: `https://serviceflow-hub-1.preview.emergentagent.com/settings/quickbooks`
- [ ] Disconnect URL configured: `https://serviceflow-hub-1.preview.emergentagent.com/settings/quickbooks`
- [ ] Privacy Policy URL configured: `https://serviceflow-hub-1.preview.emergentagent.com/legal/privacy`
- [ ] Terms of Service URL configured: `https://serviceflow-hub-1.preview.emergentagent.com/legal/terms`
- [ ] Redirect URI configured: `https://serviceflow-hub-1.preview.emergentagent.com/api/quickbooks/auth/callback`
