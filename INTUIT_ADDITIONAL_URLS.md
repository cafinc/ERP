...
**URL to provide:**
```
https://fieldservice-hub-1.preview.emergentagent.com/settings/quickbooks
```
...
```
https://fieldservice-hub-1.preview.emergentagent.com
```
...
```
Privacy Policy URL:
https://fieldservice-hub-1.preview.emergentagent.com/legal/privacy

End-User License Agreement URL (Terms of Service):
https://fieldservice-hub-1.preview.emergentagent.com/legal/terms
```
...
| **Privacy Policy URL** | `https://fieldservice-hub-1.preview.emergentagent.com/legal/privacy` |
| **Terms of Service URL** | `https://fieldservice-hub-1.preview.emergentagent.com/legal/terms` |
...
```
Launch URL: https://fieldservice-hub-1.preview.emergentagent.com
Disconnect URL: https://fieldservice-hub-1.preview.emergentagent.com
```
**Pros:**
...
```
Launch URL: https://fieldservice-hub-1.preview.emergentagent.com/settings
Disconnect URL: https://fieldservice-hub-1.preview.emergentagent.com/settings
```
**Pros:**
...
- [ ] Launch URL configured: `https://fieldservice-hub-1.preview.emergentagent.com/settings/quickbooks`
- [ ] Disconnect URL configured: `https://fieldservice-hub-1.preview.emergentagent.com/settings/quickbooks`
- [ ] Privacy Policy URL configured: `https://fieldservice-hub-1.preview.emergentagent.com/legal/privacy`
- [ ] Terms of Service URL configured: `https://fieldservice-hub-1.preview.emergentagent.com/legal/terms`
- [ ] Redirect URI configured: `https://fieldservice-hub-1.preview.emergentagent.com/api/quickbooks/auth/callback`
