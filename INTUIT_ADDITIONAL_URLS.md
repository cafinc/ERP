...
**URL to provide:**
```
https://snowtrack-admin-2.preview.emergentagent.com/settings/quickbooks
```
...
```
Privacy Policy URL:
https://snowtrack-admin-2.preview.emergentagent.com/legal/privacy

End-User License Agreement URL (Terms of Service):
https://snowtrack-admin-2.preview.emergentagent.com/legal/terms
```
...
| **Launch URL** | `https://snowtrack-admin-2.preview.emergentagent.com/settings/quickbooks` |
| **Disconnect URL** | `https://snowtrack-admin-2.preview.emergentagent.com/settings/quickbooks` |
| **Privacy Policy URL** | `https://snowtrack-admin-2.preview.emergentagent.com/legal/privacy` |
| **Terms of Service URL** | `https://snowtrack-admin-2.preview.emergentagent.com/legal/terms` |
...
```
Launch URL: https://snowtrack-admin-2.preview.emergentagent.com
Disconnect URL: https://snowtrack-admin-2.preview.emergentagent.com
```
**Pros:**
...
```
Launch URL: https://snowtrack-admin-2.preview.emergentagent.com/settings
Disconnect URL: https://snowtrack-admin-2.preview.emergentagent.com/settings
```
**Pros:**
...
- [ ] Launch URL configured: `https://snowtrack-admin-2.preview.emergentagent.com/settings/quickbooks`
- [ ] Disconnect URL configured: `https://snowtrack-admin-2.preview.emergentagent.com/settings/quickbooks`
- [ ] Privacy Policy URL configured: `https://snowtrack-admin-2.preview.emergentagent.com/legal/privacy`
- [ ] Terms of Service URL configured: `https://snowtrack-admin-2.preview.emergentagent.com/legal/terms`
- [ ] Redirect URI configured: `https://snowtrack-admin-2.preview.emergentagent.com/api/quickbooks/auth/callback`
