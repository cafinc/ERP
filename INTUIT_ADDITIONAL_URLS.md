...
**URL to provide:**
```
https://ui-unifier.preview.emergentagent.com/settings/quickbooks
```
...
```
https://ui-unifier.preview.emergentagent.com
```
...
```
Privacy Policy URL:
https://ui-unifier.preview.emergentagent.com/legal/privacy

End-User License Agreement URL (Terms of Service):
https://ui-unifier.preview.emergentagent.com/legal/terms
```

### OAuth Configuration
```
Redirect URI:
https://ui-unifier.preview.emergentagent.com/api/quickbooks/auth/callback
```
...
| **Launch URL** | `https://ui-unifier.preview.emergentagent.com/settings/quickbooks` |
| **Disconnect URL** | `https://ui-unifier.preview.emergentagent.com/settings/quickbooks` |
| **Privacy Policy URL** | `https://ui-unifier.preview.emergentagent.com/legal/privacy` |
| **Terms of Service URL** | `https://ui-unifier.preview.emergentagent.com/legal/terms` |
| **Redirect URI** | `https://ui-unifier.preview.emergentagent.com/api/quickbooks/auth/callback` |
...
```
Launch URL: https://ui-unifier.preview.emergentagent.com
Disconnect URL: https://ui-unifier.preview.emergentagent.com
```
**Pros:**
...
```
Launch URL: https://ui-unifier.preview.emergentagent.com/settings
Disconnect URL: https://ui-unifier.preview.emergentagent.com/settings
```
**Pros:**
...
- [ ] Launch URL configured: `https://ui-unifier.preview.emergentagent.com/settings/quickbooks`
- [ ] Disconnect URL configured: `https://ui-unifier.preview.emergentagent.com/settings/quickbooks`
- [ ] Privacy Policy URL configured: `https://ui-unifier.preview.emergentagent.com/legal/privacy`
- [ ] Terms of Service URL configured: `https://ui-unifier.preview.emergentagent.com/legal/terms`
- [ ] Redirect URI configured: `https://ui-unifier.preview.emergentagent.com/api/quickbooks/auth/callback`
