...
**URL to provide:**
```
https://glass-admin-dash.preview.emergentagent.com/settings/quickbooks
```
...
```
https://glass-admin-dash.preview.emergentagent.com
```
...
```
Privacy Policy URL:
https://glass-admin-dash.preview.emergentagent.com/legal/privacy

End-User License Agreement URL (Terms of Service):
https://glass-admin-dash.preview.emergentagent.com/legal/terms
```

### OAuth Configuration
```
Redirect URI:
https://glass-admin-dash.preview.emergentagent.com/api/quickbooks/auth/callback
```
...
| **Launch URL** | `https://glass-admin-dash.preview.emergentagent.com/settings/quickbooks` |
| **Disconnect URL** | `https://glass-admin-dash.preview.emergentagent.com/settings/quickbooks` |
| **Privacy Policy URL** | `https://glass-admin-dash.preview.emergentagent.com/legal/privacy` |
| **Terms of Service URL** | `https://glass-admin-dash.preview.emergentagent.com/legal/terms` |
| **Redirect URI** | `https://glass-admin-dash.preview.emergentagent.com/api/quickbooks/auth/callback` |
...
```
Launch URL: https://glass-admin-dash.preview.emergentagent.com
Disconnect URL: https://glass-admin-dash.preview.emergentagent.com
```
**Pros:**
...
```
Launch URL: https://glass-admin-dash.preview.emergentagent.com/settings
Disconnect URL: https://glass-admin-dash.preview.emergentagent.com/settings
```
**Pros:**
...
- [ ] Launch URL configured: `https://glass-admin-dash.preview.emergentagent.com/settings/quickbooks`
- [ ] Disconnect URL configured: `https://glass-admin-dash.preview.emergentagent.com/settings/quickbooks`
- [ ] Privacy Policy URL configured: `https://glass-admin-dash.preview.emergentagent.com/legal/privacy`
- [ ] Terms of Service URL configured: `https://glass-admin-dash.preview.emergentagent.com/legal/terms`
- [ ] Redirect URI configured: `https://glass-admin-dash.preview.emergentagent.com/api/quickbooks/auth/callback`
