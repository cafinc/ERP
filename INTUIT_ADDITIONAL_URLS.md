...
**URL to provide:**
```
https://access-unified.preview.emergentagent.com/settings/quickbooks
```
...
```
https://access-unified.preview.emergentagent.com
```
...
```
Privacy Policy URL:
https://access-unified.preview.emergentagent.com/legal/privacy

End-User License Agreement URL (Terms of Service):
https://access-unified.preview.emergentagent.com/legal/terms
```

### OAuth Configuration
```
Redirect URI:
https://access-unified.preview.emergentagent.com/api/quickbooks/auth/callback
```
...
| **Launch URL** | `https://access-unified.preview.emergentagent.com/settings/quickbooks` |
| **Disconnect URL** | `https://access-unified.preview.emergentagent.com/settings/quickbooks` |
| **Privacy Policy URL** | `https://access-unified.preview.emergentagent.com/legal/privacy` |
| **Terms of Service URL** | `https://access-unified.preview.emergentagent.com/legal/terms` |
| **Redirect URI** | `https://access-unified.preview.emergentagent.com/api/quickbooks/auth/callback` |
...
```
Launch URL: https://access-unified.preview.emergentagent.com
Disconnect URL: https://access-unified.preview.emergentagent.com
```
**Pros:**
...
```
Launch URL: https://access-unified.preview.emergentagent.com/settings
Disconnect URL: https://access-unified.preview.emergentagent.com/settings
```
**Pros:**
...
- [ ] Launch URL configured: `https://access-unified.preview.emergentagent.com/settings/quickbooks`
- [ ] Disconnect URL configured: `https://access-unified.preview.emergentagent.com/settings/quickbooks`
- [ ] Privacy Policy URL configured: `https://access-unified.preview.emergentagent.com/legal/privacy`
- [ ] Terms of Service URL configured: `https://access-unified.preview.emergentagent.com/legal/terms`
- [ ] Redirect URI configured: `https://access-unified.preview.emergentagent.com/api/quickbooks/auth/callback`
