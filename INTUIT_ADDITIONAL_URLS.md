...
**URL to provide:**
```
https://snowadmin-dash.preview.emergentagent.com/settings/quickbooks
```
...
```
Privacy Policy URL:
https://snowadmin-dash.preview.emergentagent.com/legal/privacy

End-User License Agreement URL (Terms of Service):
https://snowadmin-dash.preview.emergentagent.com/legal/terms
```

### OAuth Configuration
```
Redirect URI:
https://snowadmin-dash.preview.emergentagent.com/api/quickbooks/auth/callback
```
...
| **Launch URL** | `https://snowadmin-dash.preview.emergentagent.com/settings/quickbooks` |
| **Disconnect URL** | `https://snowadmin-dash.preview.emergentagent.com/settings/quickbooks` |
| **Privacy Policy URL** | `https://snowadmin-dash.preview.emergentagent.com/legal/privacy` |
| **Terms of Service URL** | `https://snowadmin-dash.preview.emergentagent.com/legal/terms` |
| **Redirect URI** | `https://snowadmin-dash.preview.emergentagent.com/api/quickbooks/auth/callback` |
...
```
Launch URL: https://snowadmin-dash.preview.emergentagent.com
Disconnect URL: https://snowadmin-dash.preview.emergentagent.com
```
**Pros:**
...
```
Launch URL: https://snowadmin-dash.preview.emergentagent.com/settings
Disconnect URL: https://snowadmin-dash.preview.emergentagent.com/settings
```
**Pros:**
...
- [ ] Launch URL configured: `https://snowadmin-dash.preview.emergentagent.com/settings/quickbooks`
- [ ] Disconnect URL configured: `https://snowadmin-dash.preview.emergentagent.com/settings/quickbooks`
- [ ] Privacy Policy URL configured: `https://snowadmin-dash.preview.emergentagent.com/legal/privacy`
- [ ] Terms of Service URL configured: `https://snowadmin-dash.preview.emergentagent.com/legal/terms`
- [ ] Redirect URI configured: `https://snowadmin-dash.preview.emergentagent.com/api/quickbooks/auth/callback`
