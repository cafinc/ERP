...
**URL to provide:**
```
https://mapbuilder-3.preview.emergentagent.com/settings/quickbooks
```
...
| **Privacy Policy URL** | `https://mapbuilder-3.preview.emergentagent.com/legal/privacy` |
| **Terms of Service URL** | `https://mapbuilder-3.preview.emergentagent.com/legal/terms` |
...
```
Launch URL: https://mapbuilder-3.preview.emergentagent.com
Disconnect URL: https://mapbuilder-3.preview.emergentagent.com
```
**Pros:**
...
```
Launch URL: https://mapbuilder-3.preview.emergentagent.com/settings
Disconnect URL: https://mapbuilder-3.preview.emergentagent.com/settings
```
**Pros:**
...
- [ ] Launch URL configured: `https://mapbuilder-3.preview.emergentagent.com/settings/quickbooks`
- [ ] Disconnect URL configured: `https://mapbuilder-3.preview.emergentagent.com/settings/quickbooks`
- [ ] Privacy Policy URL configured: `https://mapbuilder-3.preview.emergentagent.com/legal/privacy`
- [ ] Terms of Service URL configured: `https://mapbuilder-3.preview.emergentagent.com/legal/terms`
- [ ] Redirect URI configured: `https://mapbuilder-3.preview.emergentagent.com/api/quickbooks/auth/callback`
