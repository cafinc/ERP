...
**URL to provide:**
```
https://client-hub-48.preview.emergentagent.com/settings/quickbooks
```
...
```
https://client-hub-48.preview.emergentagent.com
```
...
```
Privacy Policy URL:
https://client-hub-48.preview.emergentagent.com/legal/privacy

End-User License Agreement URL (Terms of Service):
https://client-hub-48.preview.emergentagent.com/legal/terms
```

### OAuth Configuration
```
Redirect URI:
https://client-hub-48.preview.emergentagent.com/api/quickbooks/auth/callback
```
...
| **Launch URL** | `https://client-hub-48.preview.emergentagent.com/settings/quickbooks` |
| **Disconnect URL** | `https://client-hub-48.preview.emergentagent.com/settings/quickbooks` |
| **Privacy Policy URL** | `https://client-hub-48.preview.emergentagent.com/legal/privacy` |
| **Terms of Service URL** | `https://client-hub-48.preview.emergentagent.com/legal/terms` |
| **Redirect URI** | `https://client-hub-48.preview.emergentagent.com/api/quickbooks/auth/callback` |
...
```
Launch URL: https://client-hub-48.preview.emergentagent.com
Disconnect URL: https://client-hub-48.preview.emergentagent.com
```
**Pros:**
...
```
Launch URL: https://client-hub-48.preview.emergentagent.com/settings
Disconnect URL: https://client-hub-48.preview.emergentagent.com/settings
```
**Pros:**
...
- [ ] Launch URL configured: `https://client-hub-48.preview.emergentagent.com/settings/quickbooks`
- [ ] Disconnect URL configured: `https://client-hub-48.preview.emergentagent.com/settings/quickbooks`
- [ ] Privacy Policy URL configured: `https://client-hub-48.preview.emergentagent.com/legal/privacy`
- [ ] Terms of Service URL configured: `https://client-hub-48.preview.emergentagent.com/legal/terms`
- [ ] Redirect URI configured: `https://client-hub-48.preview.emergentagent.com/api/quickbooks/auth/callback`
