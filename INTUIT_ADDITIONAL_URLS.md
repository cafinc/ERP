...
**URL to provide:**
```
https://snow-dash-1.preview.emergentagent.com/settings/quickbooks
```
...
```
Privacy Policy URL:
https://snow-dash-1.preview.emergentagent.com/legal/privacy

End-User License Agreement URL (Terms of Service):
https://snow-dash-1.preview.emergentagent.com/legal/terms
```
...
| **Privacy Policy URL** | `https://snow-dash-1.preview.emergentagent.com/legal/privacy` |
| **Terms of Service URL** | `https://snow-dash-1.preview.emergentagent.com/legal/terms` |
...
```
Launch URL: https://snow-dash-1.preview.emergentagent.com
Disconnect URL: https://snow-dash-1.preview.emergentagent.com
```
**Pros:**
...
```
Launch URL: https://snow-dash-1.preview.emergentagent.com/settings
Disconnect URL: https://snow-dash-1.preview.emergentagent.com/settings
```
**Pros:**
...
- [ ] Launch URL configured: `https://snow-dash-1.preview.emergentagent.com/settings/quickbooks`
- [ ] Disconnect URL configured: `https://snow-dash-1.preview.emergentagent.com/settings/quickbooks`
- [ ] Privacy Policy URL configured: `https://snow-dash-1.preview.emergentagent.com/legal/privacy`
- [ ] Terms of Service URL configured: `https://snow-dash-1.preview.emergentagent.com/legal/terms`
- [ ] Redirect URI configured: `https://snow-dash-1.preview.emergentagent.com/api/quickbooks/auth/callback`
