...
**URL to provide:**
```
https://asset-mgmt-portal.preview.emergentagent.com/settings/quickbooks
```
...
```
https://asset-mgmt-portal.preview.emergentagent.com
```
...
```
Privacy Policy URL:
https://asset-mgmt-portal.preview.emergentagent.com/legal/privacy

End-User License Agreement URL (Terms of Service):
https://asset-mgmt-portal.preview.emergentagent.com/legal/terms
```

### OAuth Configuration
```
Redirect URI:
https://asset-mgmt-portal.preview.emergentagent.com/api/quickbooks/auth/callback
```
...
| **Launch URL** | `https://asset-mgmt-portal.preview.emergentagent.com/settings/quickbooks` |
| **Disconnect URL** | `https://asset-mgmt-portal.preview.emergentagent.com/settings/quickbooks` |
| **Privacy Policy URL** | `https://asset-mgmt-portal.preview.emergentagent.com/legal/privacy` |
| **Terms of Service URL** | `https://asset-mgmt-portal.preview.emergentagent.com/legal/terms` |
| **Redirect URI** | `https://asset-mgmt-portal.preview.emergentagent.com/api/quickbooks/auth/callback` |
...
```
Launch URL: https://asset-mgmt-portal.preview.emergentagent.com
Disconnect URL: https://asset-mgmt-portal.preview.emergentagent.com
```
**Pros:**
...
```
Launch URL: https://asset-mgmt-portal.preview.emergentagent.com/settings
Disconnect URL: https://asset-mgmt-portal.preview.emergentagent.com/settings
```
**Pros:**
...
- [ ] Launch URL configured: `https://asset-mgmt-portal.preview.emergentagent.com/settings/quickbooks`
- [ ] Disconnect URL configured: `https://asset-mgmt-portal.preview.emergentagent.com/settings/quickbooks`
- [ ] Privacy Policy URL configured: `https://asset-mgmt-portal.preview.emergentagent.com/legal/privacy`
- [ ] Terms of Service URL configured: `https://asset-mgmt-portal.preview.emergentagent.com/legal/terms`
- [ ] Redirect URI configured: `https://asset-mgmt-portal.preview.emergentagent.com/api/quickbooks/auth/callback`
