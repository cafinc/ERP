...
**URL to provide:**
```
https://webadmin-rescue.preview.emergentagent.com/settings/quickbooks
```
...
```
https://webadmin-rescue.preview.emergentagent.com
```
...
```
Privacy Policy URL:
https://webadmin-rescue.preview.emergentagent.com/legal/privacy

End-User License Agreement URL (Terms of Service):
https://webadmin-rescue.preview.emergentagent.com/legal/terms
```

### OAuth Configuration
```
Redirect URI:
https://webadmin-rescue.preview.emergentagent.com/api/quickbooks/auth/callback
```
...
| **Launch URL** | `https://webadmin-rescue.preview.emergentagent.com/settings/quickbooks` |
| **Disconnect URL** | `https://webadmin-rescue.preview.emergentagent.com/settings/quickbooks` |
| **Privacy Policy URL** | `https://webadmin-rescue.preview.emergentagent.com/legal/privacy` |
| **Terms of Service URL** | `https://webadmin-rescue.preview.emergentagent.com/legal/terms` |
| **Redirect URI** | `https://webadmin-rescue.preview.emergentagent.com/api/quickbooks/auth/callback` |
...
```
Launch URL: https://webadmin-rescue.preview.emergentagent.com
Disconnect URL: https://webadmin-rescue.preview.emergentagent.com
```
**Pros:**
...
```
Launch URL: https://webadmin-rescue.preview.emergentagent.com/settings
Disconnect URL: https://webadmin-rescue.preview.emergentagent.com/settings
```
**Pros:**
...
- [ ] Launch URL configured: `https://webadmin-rescue.preview.emergentagent.com/settings/quickbooks`
- [ ] Disconnect URL configured: `https://webadmin-rescue.preview.emergentagent.com/settings/quickbooks`
- [ ] Privacy Policy URL configured: `https://webadmin-rescue.preview.emergentagent.com/legal/privacy`
- [ ] Terms of Service URL configured: `https://webadmin-rescue.preview.emergentagent.com/legal/terms`
- [ ] Redirect URI configured: `https://webadmin-rescue.preview.emergentagent.com/api/quickbooks/auth/callback`
