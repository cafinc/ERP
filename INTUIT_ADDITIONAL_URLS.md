...
**URL to provide:**
```
https://snowconnect.preview.emergentagent.com/settings/quickbooks
```
...
| **Launch URL** | `https://snowconnect.preview.emergentagent.com/settings/quickbooks` |
| **Disconnect URL** | `https://snowconnect.preview.emergentagent.com/settings/quickbooks` |
| **Privacy Policy URL** | `https://snowconnect.preview.emergentagent.com/legal/privacy` |
| **Terms of Service URL** | `https://snowconnect.preview.emergentagent.com/legal/terms` |
| **Redirect URI** | `https://snowconnect.preview.emergentagent.com/api/quickbooks/auth/callback` |
...
```
Launch URL: https://snowconnect.preview.emergentagent.com
Disconnect URL: https://snowconnect.preview.emergentagent.com
```
**Pros:**
...
```
Launch URL: https://snowconnect.preview.emergentagent.com/settings
Disconnect URL: https://snowconnect.preview.emergentagent.com/settings
```
**Pros:**
...
- [ ] Launch URL configured: `https://snowconnect.preview.emergentagent.com/settings/quickbooks`
- [ ] Disconnect URL configured: `https://snowconnect.preview.emergentagent.com/settings/quickbooks`
- [ ] Privacy Policy URL configured: `https://snowconnect.preview.emergentagent.com/legal/privacy`
- [ ] Terms of Service URL configured: `https://snowconnect.preview.emergentagent.com/legal/terms`
- [ ] Redirect URI configured: `https://snowconnect.preview.emergentagent.com/api/quickbooks/auth/callback`
