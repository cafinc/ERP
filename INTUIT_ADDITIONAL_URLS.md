...
**URL to provide:**
```
https://asset-admin-1.preview.emergentagent.com/settings/quickbooks
```
...
```
https://asset-admin-1.preview.emergentagent.com
```
...
```
Privacy Policy URL:
https://asset-admin-1.preview.emergentagent.com/legal/privacy

End-User License Agreement URL (Terms of Service):
https://asset-admin-1.preview.emergentagent.com/legal/terms
```
...
| **Launch URL** | `https://asset-admin-1.preview.emergentagent.com/settings/quickbooks` |
| **Disconnect URL** | `https://asset-admin-1.preview.emergentagent.com/settings/quickbooks` |
| **Privacy Policy URL** | `https://asset-admin-1.preview.emergentagent.com/legal/privacy` |
| **Terms of Service URL** | `https://asset-admin-1.preview.emergentagent.com/legal/terms` |
...
```
Launch URL: https://asset-admin-1.preview.emergentagent.com
Disconnect URL: https://asset-admin-1.preview.emergentagent.com
```
**Pros:**
...
```
Launch URL: https://asset-admin-1.preview.emergentagent.com/settings
Disconnect URL: https://asset-admin-1.preview.emergentagent.com/settings
```
**Pros:**
...
- [ ] Launch URL configured: `https://asset-admin-1.preview.emergentagent.com/settings/quickbooks`
- [ ] Disconnect URL configured: `https://asset-admin-1.preview.emergentagent.com/settings/quickbooks`
- [ ] Privacy Policy URL configured: `https://asset-admin-1.preview.emergentagent.com/legal/privacy`
- [ ] Terms of Service URL configured: `https://asset-admin-1.preview.emergentagent.com/legal/terms`
- [ ] Redirect URI configured: `https://asset-admin-1.preview.emergentagent.com/api/quickbooks/auth/callback`
