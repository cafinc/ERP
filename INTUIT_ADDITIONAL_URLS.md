...
**URL to provide:**
```
https://plowpro-admin-1.preview.emergentagent.com/settings/quickbooks
```
...
```
Privacy Policy URL:
https://plowpro-admin-1.preview.emergentagent.com/legal/privacy

End-User License Agreement URL (Terms of Service):
https://plowpro-admin-1.preview.emergentagent.com/legal/terms
```
...
| **Launch URL** | `https://plowpro-admin-1.preview.emergentagent.com/settings/quickbooks` |
| **Disconnect URL** | `https://plowpro-admin-1.preview.emergentagent.com/settings/quickbooks` |
| **Privacy Policy URL** | `https://plowpro-admin-1.preview.emergentagent.com/legal/privacy` |
| **Terms of Service URL** | `https://plowpro-admin-1.preview.emergentagent.com/legal/terms` |
| **Redirect URI** | `https://plowpro-admin-1.preview.emergentagent.com/api/quickbooks/auth/callback` |
...
```
Launch URL: https://plowpro-admin-1.preview.emergentagent.com
Disconnect URL: https://plowpro-admin-1.preview.emergentagent.com
```
**Pros:**
...
```
Launch URL: https://plowpro-admin-1.preview.emergentagent.com/settings
Disconnect URL: https://plowpro-admin-1.preview.emergentagent.com/settings
```
**Pros:**
...
- [ ] Launch URL configured: `https://plowpro-admin-1.preview.emergentagent.com/settings/quickbooks`
- [ ] Disconnect URL configured: `https://plowpro-admin-1.preview.emergentagent.com/settings/quickbooks`
- [ ] Privacy Policy URL configured: `https://plowpro-admin-1.preview.emergentagent.com/legal/privacy`
- [ ] Terms of Service URL configured: `https://plowpro-admin-1.preview.emergentagent.com/legal/terms`
- [ ] Redirect URI configured: `https://plowpro-admin-1.preview.emergentagent.com/api/quickbooks/auth/callback`
