...
**URL to provide:**
```
https://erp-modernize-2.preview.emergentagent.com/settings/quickbooks
```
...
```
https://erp-modernize-2.preview.emergentagent.com
```
...
```
Privacy Policy URL:
https://erp-modernize-2.preview.emergentagent.com/legal/privacy

End-User License Agreement URL (Terms of Service):
https://erp-modernize-2.preview.emergentagent.com/legal/terms
```

### OAuth Configuration
```
Redirect URI:
https://erp-modernize-2.preview.emergentagent.com/api/quickbooks/auth/callback
```
...
| **Launch URL** | `https://erp-modernize-2.preview.emergentagent.com/settings/quickbooks` |
| **Disconnect URL** | `https://erp-modernize-2.preview.emergentagent.com/settings/quickbooks` |
| **Privacy Policy URL** | `https://erp-modernize-2.preview.emergentagent.com/legal/privacy` |
| **Terms of Service URL** | `https://erp-modernize-2.preview.emergentagent.com/legal/terms` |
| **Redirect URI** | `https://erp-modernize-2.preview.emergentagent.com/api/quickbooks/auth/callback` |
...
```
Launch URL: https://erp-modernize-2.preview.emergentagent.com
Disconnect URL: https://erp-modernize-2.preview.emergentagent.com
```
**Pros:**
...
```
Launch URL: https://erp-modernize-2.preview.emergentagent.com/settings
Disconnect URL: https://erp-modernize-2.preview.emergentagent.com/settings
```
**Pros:**
...
- [ ] Launch URL configured: `https://erp-modernize-2.preview.emergentagent.com/settings/quickbooks`
- [ ] Disconnect URL configured: `https://erp-modernize-2.preview.emergentagent.com/settings/quickbooks`
- [ ] Privacy Policy URL configured: `https://erp-modernize-2.preview.emergentagent.com/legal/privacy`
- [ ] Terms of Service URL configured: `https://erp-modernize-2.preview.emergentagent.com/legal/terms`
- [ ] Redirect URI configured: `https://erp-modernize-2.preview.emergentagent.com/api/quickbooks/auth/callback`
