...
**URL to provide:**
```
https://header-refresh-4.preview.emergentagent.com/settings/quickbooks
```
...
```
Privacy Policy URL:
https://header-refresh-4.preview.emergentagent.com/legal/privacy

End-User License Agreement URL (Terms of Service):
https://header-refresh-4.preview.emergentagent.com/legal/terms
```

### OAuth Configuration
```
Redirect URI:
https://header-refresh-4.preview.emergentagent.com/api/quickbooks/auth/callback
```
...
| **Privacy Policy URL** | `https://header-refresh-4.preview.emergentagent.com/legal/privacy` |
| **Terms of Service URL** | `https://header-refresh-4.preview.emergentagent.com/legal/terms` |
...
```
Launch URL: https://header-refresh-4.preview.emergentagent.com
Disconnect URL: https://header-refresh-4.preview.emergentagent.com
```
**Pros:**
...
```
Launch URL: https://header-refresh-4.preview.emergentagent.com/settings
Disconnect URL: https://header-refresh-4.preview.emergentagent.com/settings
```
**Pros:**
...
- [ ] Launch URL configured: `https://header-refresh-4.preview.emergentagent.com/settings/quickbooks`
- [ ] Disconnect URL configured: `https://header-refresh-4.preview.emergentagent.com/settings/quickbooks`
- [ ] Privacy Policy URL configured: `https://header-refresh-4.preview.emergentagent.com/legal/privacy`
- [ ] Terms of Service URL configured: `https://header-refresh-4.preview.emergentagent.com/legal/terms`
- [ ] Redirect URI configured: `https://header-refresh-4.preview.emergentagent.com/api/quickbooks/auth/callback`
