...
RINGCENTRAL_REDIRECT_URI=https://snowy-dashboard.preview.emergentagent.com/api/auth/ringcentral/callback
```
...
3. Use this webhook URL:
   ```
   https://snowy-dashboard.preview.emergentagent.com/api/webhooks/ringcentral
   ```
...
webhook_response = requests.post(
    ...
    json={
        ...
        'deliveryMode': {
            ...
            'address': 'https://snowy-dashboard.preview.emergentagent.com/api/webhooks/ringcentral'
        },
...
curl -X POST "https://snowy-dashboard.preview.emergentagent.com/api/webhooks/ringcentral" \
...
# Check active calls
curl "https://snowy-dashboard.preview.emergentagent.com/api/ringcentral/active-calls"
```
...
1. Open web admin: https://snowy-dashboard.preview.emergentagent.com
