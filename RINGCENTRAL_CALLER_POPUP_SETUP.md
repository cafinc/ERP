...
RINGCENTRAL_REDIRECT_URI=https://custflow-1.preview.emergentagent.com/api/auth/ringcentral/callback
```
...
3. Use this webhook URL:
   ```
   https://custflow-1.preview.emergentagent.com/api/webhooks/ringcentral
   ```
...
webhook_response = requests.post(
    ...
    json={
        ...
        'deliveryMode': {
            ...
            'address': 'https://custflow-1.preview.emergentagent.com/api/webhooks/ringcentral'
        },
...
curl -X POST "https://custflow-1.preview.emergentagent.com/api/webhooks/ringcentral" \
...
# Check active calls
curl "https://custflow-1.preview.emergentagent.com/api/ringcentral/active-calls"
```
...
1. Open web admin: https://custflow-1.preview.emergentagent.com
