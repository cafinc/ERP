...
RINGCENTRAL_REDIRECT_URI=https://snowtrackr.preview.emergentagent.com/api/auth/ringcentral/callback
```
...
3. Use this webhook URL:
   ```
   https://snowtrackr.preview.emergentagent.com/api/webhooks/ringcentral
   ```
...
webhook_response = requests.post(
    ...
    json={
        ...
        'deliveryMode': {
            ...
            'address': 'https://snowtrackr.preview.emergentagent.com/api/webhooks/ringcentral'
        },
...
curl -X POST "https://snowtrackr.preview.emergentagent.com/api/webhooks/ringcentral" \
...
# Check active calls
curl "https://snowtrackr.preview.emergentagent.com/api/ringcentral/active-calls"
```
...
1. Open web admin: https://snowtrackr.preview.emergentagent.com
