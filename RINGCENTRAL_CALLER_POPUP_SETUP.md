...
RINGCENTRAL_REDIRECT_URI=https://map-measure-admin.preview.emergentagent.com/api/auth/ringcentral/callback
```
...
3. Use this webhook URL:
   ```
   https://map-measure-admin.preview.emergentagent.com/api/webhooks/ringcentral
   ```
...
webhook_response = requests.post(
    ...
    json={
        ...
        'deliveryMode': {
            ...
            'address': 'https://map-measure-admin.preview.emergentagent.com/api/webhooks/ringcentral'
        },
...
curl -X POST "https://map-measure-admin.preview.emergentagent.com/api/webhooks/ringcentral" \
...
# Check active calls
curl "https://map-measure-admin.preview.emergentagent.com/api/ringcentral/active-calls"
```
...
1. Open web admin: https://map-measure-admin.preview.emergentagent.com
