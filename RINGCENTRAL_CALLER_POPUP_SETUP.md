...
RINGCENTRAL_REDIRECT_URI=https://ui-unifier.preview.emergentagent.com/api/auth/ringcentral/callback
```
...
3. Use this webhook URL:
   ```
   https://ui-unifier.preview.emergentagent.com/api/webhooks/ringcentral
   ```
...
webhook_response = requests.post(
    ...
    json={
        ...
        'deliveryMode': {
            ...
            'address': 'https://ui-unifier.preview.emergentagent.com/api/webhooks/ringcentral'
        },
...
curl -X POST "https://ui-unifier.preview.emergentagent.com/api/webhooks/ringcentral" \
...
# Check active calls
curl "https://ui-unifier.preview.emergentagent.com/api/ringcentral/active-calls"
```
...
1. Open web admin: https://ui-unifier.preview.emergentagent.com
