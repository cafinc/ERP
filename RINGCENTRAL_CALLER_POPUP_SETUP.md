...
RINGCENTRAL_REDIRECT_URI=https://mapbuilder-3.preview.emergentagent.com/api/auth/ringcentral/callback
```
...
3. Use this webhook URL:
   ```
   https://mapbuilder-3.preview.emergentagent.com/api/webhooks/ringcentral
   ```
...
webhook_response = requests.post(
    ...
    json={
        ...
        'deliveryMode': {
            ...
            'address': 'https://mapbuilder-3.preview.emergentagent.com/api/webhooks/ringcentral'
        },
...
curl -X POST "https://mapbuilder-3.preview.emergentagent.com/api/webhooks/ringcentral" \
...
# Check active calls
curl "https://mapbuilder-3.preview.emergentagent.com/api/ringcentral/active-calls"
```
...
1. Open web admin: https://mapbuilder-3.preview.emergentagent.com
