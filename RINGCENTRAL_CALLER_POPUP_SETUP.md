...
RINGCENTRAL_REDIRECT_URI=https://admin-jsx-fixes.preview.emergentagent.com/api/auth/ringcentral/callback
```
...
3. Use this webhook URL:
   ```
   https://admin-jsx-fixes.preview.emergentagent.com/api/webhooks/ringcentral
   ```
...
webhook_response = requests.post(
    ...
    json={
        ...
        'deliveryMode': {
            ...
            'address': 'https://admin-jsx-fixes.preview.emergentagent.com/api/webhooks/ringcentral'
        },
...
curl -X POST "https://admin-jsx-fixes.preview.emergentagent.com/api/webhooks/ringcentral" \
...
# Check active calls
curl "https://admin-jsx-fixes.preview.emergentagent.com/api/ringcentral/active-calls"
```
...
1. Open web admin: https://admin-jsx-fixes.preview.emergentagent.com
