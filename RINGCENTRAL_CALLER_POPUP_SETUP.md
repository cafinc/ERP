...
RINGCENTRAL_REDIRECT_URI=https://snowtrack-admin-2.preview.emergentagent.com/api/auth/ringcentral/callback
```
...
3. Use this webhook URL:
   ```
   https://snowtrack-admin-2.preview.emergentagent.com/api/webhooks/ringcentral
   ```
...
webhook_response = requests.post(
    ...
    json={
        ...
        'deliveryMode': {
            ...
            'address': 'https://snowtrack-admin-2.preview.emergentagent.com/api/webhooks/ringcentral'
        },
...
curl -X POST "https://snowtrack-admin-2.preview.emergentagent.com/api/webhooks/ringcentral" \
...
# Check active calls
curl "https://snowtrack-admin-2.preview.emergentagent.com/api/ringcentral/active-calls"
```
...
1. Open web admin: https://snowtrack-admin-2.preview.emergentagent.com
