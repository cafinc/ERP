...
RINGCENTRAL_REDIRECT_URI=https://webadmin-jsx.preview.emergentagent.com/api/auth/ringcentral/callback
```
...
3. Use this webhook URL:
   ```
   https://webadmin-jsx.preview.emergentagent.com/api/webhooks/ringcentral
   ```
...
webhook_response = requests.post(
    ...
    json={
        ...
        'deliveryMode': {
            ...
            'address': 'https://webadmin-jsx.preview.emergentagent.com/api/webhooks/ringcentral'
        },
...
curl -X POST "https://webadmin-jsx.preview.emergentagent.com/api/webhooks/ringcentral" \
...
# Check active calls
curl "https://webadmin-jsx.preview.emergentagent.com/api/ringcentral/active-calls"
```
...
1. Open web admin: https://webadmin-jsx.preview.emergentagent.com
