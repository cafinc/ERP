...
RINGCENTRAL_REDIRECT_URI=https://header-refresh-4.preview.emergentagent.com/api/auth/ringcentral/callback
```
...
3. Use this webhook URL:
   ```
   https://header-refresh-4.preview.emergentagent.com/api/webhooks/ringcentral
   ```
...
webhook_response = requests.post(
    ...
    json={
        ...
        'deliveryMode': {
            ...
            'address': 'https://header-refresh-4.preview.emergentagent.com/api/webhooks/ringcentral'
        },
...
curl -X POST "https://header-refresh-4.preview.emergentagent.com/api/webhooks/ringcentral" \
...
# Check active calls
curl "https://header-refresh-4.preview.emergentagent.com/api/ringcentral/active-calls"
```
...
1. Open web admin: https://header-refresh-4.preview.emergentagent.com
