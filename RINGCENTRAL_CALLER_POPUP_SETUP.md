...
RINGCENTRAL_REDIRECT_URI=https://access-unified.preview.emergentagent.com/api/auth/ringcentral/callback
```
...
3. Use this webhook URL:
   ```
   https://access-unified.preview.emergentagent.com/api/webhooks/ringcentral
   ```
...
webhook_response = requests.post(
    ...
    json={
        ...
        'deliveryMode': {
            ...
            'address': 'https://access-unified.preview.emergentagent.com/api/webhooks/ringcentral'
        },
...
curl -X POST "https://access-unified.preview.emergentagent.com/api/webhooks/ringcentral" \
...
# Check active calls
curl "https://access-unified.preview.emergentagent.com/api/ringcentral/active-calls"
```
...
1. Open web admin: https://access-unified.preview.emergentagent.com
