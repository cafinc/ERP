...
RINGCENTRAL_REDIRECT_URI=https://client-hub-48.preview.emergentagent.com/api/auth/ringcentral/callback
```
...
3. Use this webhook URL:
   ```
   https://client-hub-48.preview.emergentagent.com/api/webhooks/ringcentral
   ```
...
webhook_response = requests.post(
    ...
    json={
        ...
        'deliveryMode': {
            ...
            'address': 'https://client-hub-48.preview.emergentagent.com/api/webhooks/ringcentral'
        },
...
curl -X POST "https://client-hub-48.preview.emergentagent.com/api/webhooks/ringcentral" \
...
# Check active calls
curl "https://client-hub-48.preview.emergentagent.com/api/ringcentral/active-calls"
```
...
1. Open web admin: https://client-hub-48.preview.emergentagent.com
