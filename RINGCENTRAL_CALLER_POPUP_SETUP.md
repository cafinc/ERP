...
RINGCENTRAL_REDIRECT_URI=https://snowmsg-hub.preview.emergentagent.com/api/auth/ringcentral/callback
```
...
3. Use this webhook URL:
   ```
   https://snowmsg-hub.preview.emergentagent.com/api/webhooks/ringcentral
   ```
...
webhook_response = requests.post(
    ...
    json={
        ...
        'deliveryMode': {
            ...
            'address': 'https://snowmsg-hub.preview.emergentagent.com/api/webhooks/ringcentral'
        },
...
curl -X POST "https://snowmsg-hub.preview.emergentagent.com/api/webhooks/ringcentral" \
...
# Check active calls
curl "https://snowmsg-hub.preview.emergentagent.com/api/ringcentral/active-calls"
```
...
1. Open web admin: https://snowmsg-hub.preview.emergentagent.com
