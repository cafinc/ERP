...
RINGCENTRAL_REDIRECT_URI=https://asset-mgmt-portal.preview.emergentagent.com/api/auth/ringcentral/callback
```
...
3. Use this webhook URL:
   ```
   https://asset-mgmt-portal.preview.emergentagent.com/api/webhooks/ringcentral
   ```
...
webhook_response = requests.post(
    ...
    json={
        ...
        'deliveryMode': {
            ...
            'address': 'https://asset-mgmt-portal.preview.emergentagent.com/api/webhooks/ringcentral'
        },
...
curl -X POST "https://asset-mgmt-portal.preview.emergentagent.com/api/webhooks/ringcentral" \
...
# Check active calls
curl "https://asset-mgmt-portal.preview.emergentagent.com/api/ringcentral/active-calls"
```
...
1. Open web admin: https://asset-mgmt-portal.preview.emergentagent.com
