...
RINGCENTRAL_REDIRECT_URI=https://glass-admin-dash.preview.emergentagent.com/api/auth/ringcentral/callback
```
...
3. Use this webhook URL:
   ```
   https://glass-admin-dash.preview.emergentagent.com/api/webhooks/ringcentral
   ```
...
webhook_response = requests.post(
    ...
    json={
        ...
        'deliveryMode': {
            ...
            'address': 'https://glass-admin-dash.preview.emergentagent.com/api/webhooks/ringcentral'
        },
...
curl -X POST "https://glass-admin-dash.preview.emergentagent.com/api/webhooks/ringcentral" \
...
# Check active calls
curl "https://glass-admin-dash.preview.emergentagent.com/api/ringcentral/active-calls"
```
...
1. Open web admin: https://glass-admin-dash.preview.emergentagent.com
