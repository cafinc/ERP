...
RINGCENTRAL_REDIRECT_URI=https://plowpro-admin-1.preview.emergentagent.com/api/auth/ringcentral/callback
```
...
3. Use this webhook URL:
   ```
   https://plowpro-admin-1.preview.emergentagent.com/api/webhooks/ringcentral
   ```
...
webhook_response = requests.post(
    ...
    json={
        ...
        'deliveryMode': {
            ...
            'address': 'https://plowpro-admin-1.preview.emergentagent.com/api/webhooks/ringcentral'
        },
...
curl -X POST "https://plowpro-admin-1.preview.emergentagent.com/api/webhooks/ringcentral" \
...
# Check active calls
curl "https://plowpro-admin-1.preview.emergentagent.com/api/ringcentral/active-calls"
```
...
1. Open web admin: https://plowpro-admin-1.preview.emergentagent.com
