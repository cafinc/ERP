...
1. **Keys & OAuth tab**
   ...
   - [ ] Redirect URI is configured: `https://snowops-admin.preview.emergentagent.com/api/quickbooks/auth/callback`
...
1. Open your web admin: https://snowops-admin.preview.emergentagent.com
...
Redirect URI: https://snowops-admin.preview.emergentagent.com/api/quickbooks/auth/callback ← Same!
...
1. **Verify Redirect URI** (Most Important!)
   ...
   - Confirm redirect URI is: `https://snowops-admin.preview.emergentagent.com/api/quickbooks/auth/callback`
