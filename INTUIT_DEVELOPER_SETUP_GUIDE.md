...
1. **Keys & OAuth tab**
   ...
   - [ ] Redirect URI is configured: `https://winterwork-hub.preview.emergentagent.com/api/quickbooks/auth/callback`
...
1. Open your web admin: https://winterwork-hub.preview.emergentagent.com
...
Redirect URI: https://winterwork-hub.preview.emergentagent.com/api/quickbooks/auth/callback ← Same!
...
1. **Verify Redirect URI** (Most Important!)
   ...
   - Confirm redirect URI is: `https://winterwork-hub.preview.emergentagent.com/api/quickbooks/auth/callback`
