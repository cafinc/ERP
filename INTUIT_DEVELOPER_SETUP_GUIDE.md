...
1. **Keys & OAuth tab**
   ...
   - [ ] Redirect URI is configured: `https://snowconnect.preview.emergentagent.com/api/quickbooks/auth/callback`
...
1. Open your web admin: https://snowconnect.preview.emergentagent.com
...
Redirect URI: https://snowconnect.preview.emergentagent.com/api/quickbooks/auth/callback ← Same!
...
1. **Verify Redirect URI** (Most Important!)
   ...
   - Confirm redirect URI is: `https://snowconnect.preview.emergentagent.com/api/quickbooks/auth/callback`
