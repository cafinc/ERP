...
1. **Keys & OAuth tab**
   ...
   - [ ] Redirect URI is configured: `https://snowtrack-admin-1.preview.emergentagent.com/api/quickbooks/auth/callback`
...
1. Open your web admin: https://snowtrack-admin-1.preview.emergentagent.com
...
Redirect URI: https://snowtrack-admin-1.preview.emergentagent.com/api/quickbooks/auth/callback ← Same!
...
1. **Verify Redirect URI** (Most Important!)
   ...
   - Confirm redirect URI is: `https://snowtrack-admin-1.preview.emergentagent.com/api/quickbooks/auth/callback`
