...
1. **Keys & OAuth tab**
   ...
   - [ ] Redirect URI is configured: `https://erp-modernizer.preview.emergentagent.com/api/quickbooks/auth/callback`
...
1. Open your web admin: https://erp-modernizer.preview.emergentagent.com
...
Redirect URI: https://erp-modernizer.preview.emergentagent.com/api/quickbooks/auth/callback ← Same!
...
1. **Verify Redirect URI** (Most Important!)
   ...
   - Confirm redirect URI is: `https://erp-modernizer.preview.emergentagent.com/api/quickbooks/auth/callback`
