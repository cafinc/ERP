...
1. **Keys & OAuth tab**
   ...
   - [ ] Redirect URI is configured: `https://service-hub-166.preview.emergentagent.com/api/quickbooks/auth/callback`
...
1. Open your web admin: https://service-hub-166.preview.emergentagent.com
...
Redirect URI: https://service-hub-166.preview.emergentagent.com/api/quickbooks/auth/callback ← Same!
...
1. **Verify Redirect URI** (Most Important!)
   ...
   - Confirm redirect URI is: `https://service-hub-166.preview.emergentagent.com/api/quickbooks/auth/callback`
