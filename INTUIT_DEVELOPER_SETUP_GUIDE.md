...
1. **Keys & OAuth tab**
   ...
   - [ ] Redirect URI is configured: `https://admin-jsx-fixes.preview.emergentagent.com/api/quickbooks/auth/callback`
...
1. Open your web admin: https://admin-jsx-fixes.preview.emergentagent.com
...
Redirect URI: https://admin-jsx-fixes.preview.emergentagent.com/api/quickbooks/auth/callback ← Same!
...
1. **Verify Redirect URI** (Most Important!)
   ...
   - Confirm redirect URI is: `https://admin-jsx-fixes.preview.emergentagent.com/api/quickbooks/auth/callback`
