...
1. **Keys & OAuth tab**
   ...
   - [ ] Redirect URI is configured: `https://glass-admin-dash.preview.emergentagent.com/api/quickbooks/auth/callback`
...
1. Open your web admin: https://glass-admin-dash.preview.emergentagent.com
...
Redirect URI: https://glass-admin-dash.preview.emergentagent.com/api/quickbooks/auth/callback ← Same!
...
1. **Verify Redirect URI** (Most Important!)
   ...
   - Confirm redirect URI is: `https://glass-admin-dash.preview.emergentagent.com/api/quickbooks/auth/callback`
