...
1. **Keys & OAuth tab**
   ...
   - [ ] Redirect URI is configured: `https://map-measure-admin.preview.emergentagent.com/api/quickbooks/auth/callback`
...
1. Open your web admin: https://map-measure-admin.preview.emergentagent.com
...
Redirect URI: https://map-measure-admin.preview.emergentagent.com/api/quickbooks/auth/callback ← Same!
...
1. **Verify Redirect URI** (Most Important!)
   ...
   - Confirm redirect URI is: `https://map-measure-admin.preview.emergentagent.com/api/quickbooks/auth/callback`
