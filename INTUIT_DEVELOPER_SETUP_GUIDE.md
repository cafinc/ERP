...
1. **Keys & OAuth tab**
   ...
   - [ ] Redirect URI is configured: `https://custflow-1.preview.emergentagent.com/api/quickbooks/auth/callback`
...
1. Open your web admin: https://custflow-1.preview.emergentagent.com
...
Redirect URI: https://custflow-1.preview.emergentagent.com/api/quickbooks/auth/callback ← Same!
...
1. **Verify Redirect URI** (Most Important!)
   ...
   - Confirm redirect URI is: `https://custflow-1.preview.emergentagent.com/api/quickbooks/auth/callback`
