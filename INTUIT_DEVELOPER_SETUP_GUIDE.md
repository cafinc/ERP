...
1. **Keys & OAuth tab**
   ...
   - [ ] Redirect URI is configured: `https://snowmap-admin.preview.emergentagent.com/api/quickbooks/auth/callback`
...
1. Open your web admin: https://snowmap-admin.preview.emergentagent.com
...
Redirect URI: https://snowmap-admin.preview.emergentagent.com/api/quickbooks/auth/callback ← Same!
...
1. **Verify Redirect URI** (Most Important!)
   ...
   - Confirm redirect URI is: `https://snowmap-admin.preview.emergentagent.com/api/quickbooks/auth/callback`
