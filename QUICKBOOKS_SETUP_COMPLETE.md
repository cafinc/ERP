...
1. Open your web admin dashboard: https://mapbuilder-3.preview.emergentagent.com
...
```bash
curl -X POST 'https://mapbuilder-3.preview.emergentagent.com/api/quickbooks/customers?user_id=YOUR_USER_ID' \
...
```bash
curl 'https://mapbuilder-3.preview.emergentagent.com/api/quickbooks/connection/status?user_id=YOUR_USER_ID'
```

### Test 3: List Customers from QuickBooks

```bash
curl 'https://mapbuilder-3.preview.emergentagent.com/api/quickbooks/customers?user_id=YOUR_USER_ID'
```
