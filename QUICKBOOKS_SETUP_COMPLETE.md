...
1. Open your web admin dashboard: https://service-hub-166.preview.emergentagent.com
...
```bash
curl 'https://service-hub-166.preview.emergentagent.com/api/quickbooks/connection/status?user_id=YOUR_USER_ID'
```

### Test 3: List Customers from QuickBooks

```bash
curl 'https://service-hub-166.preview.emergentagent.com/api/quickbooks/customers?user_id=YOUR_USER_ID'
```
