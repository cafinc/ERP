...
1. Open your web admin dashboard: https://snowmsg-hub.preview.emergentagent.com
...
```bash
curl -X POST 'https://snowmsg-hub.preview.emergentagent.com/api/quickbooks/customers?user_id=YOUR_USER_ID' \
...
```bash
curl 'https://snowmsg-hub.preview.emergentagent.com/api/quickbooks/connection/status?user_id=YOUR_USER_ID'
```

### Test 3: List Customers from QuickBooks

```bash
curl 'https://snowmsg-hub.preview.emergentagent.com/api/quickbooks/customers?user_id=YOUR_USER_ID'
```
