...
1. Open your web admin dashboard: https://access-unified.preview.emergentagent.com
...
```bash
curl 'https://access-unified.preview.emergentagent.com/api/quickbooks/connection/status?user_id=YOUR_USER_ID'
```

### Test 3: List Customers from QuickBooks

```bash
curl 'https://access-unified.preview.emergentagent.com/api/quickbooks/customers?user_id=YOUR_USER_ID'
```
